...
inputTelefono.addEventListener("input", () => {
    if (!/^[\d\s]*$/.test(inputTelefono.value)) {
        mensajeTelefono.textContent = "⚠️ Solo se permiten números y espacios.";
    } else {
    ...
    form.addEventListener("submit", function(e) {
        ...
        if (!/^\d+$/.test(nuevaCita.telefono)) {
        alert("⚠️ El número de teléfono solo debe contener dígitos.");
        return;
        }
