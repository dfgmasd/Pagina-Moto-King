...
function actualizarCantidad(index, nuevaCantidad) {
    ...
    if (cantidad > 0 && cantidad <= 10) {
        ...
        alert("Solo puedes agregar hasta 10 unidades de este producto.");
    } else {
        carrito.splice(index, 1);
    }
    actualizarCarrito();
...
function agregarAlCarrito(nombreProducto, precio) {
    ...
    if (productoExistente.cantidad < 10) {
        ...
        alert("Límite máximo de 10 unidades por producto.");
    }
} else {
...
function confirmarCompra() {
    ...
    .then(data => {
        ...
        const mp = new MercadoPago("APP_USR-d6077e07-5272-41c7-ad0b-6becb68cdcfb", {
            locale: "es-PE"
        });
        ...
        mp.checkout({
            ...
            render: {
                ...
                label: "💳 Finalizar pago con Mercado Pago"
            }
        });

        mostrarMensajeRapido("Se generó el botón de pago. Finaliza tu compra.");
    })
    .catch(error => {
        console.error("Error al generar pago:", error);
        alert("No se pudo generar el pago. Inténtalo más tarde.");
    });
}
